    ...
    return async function (dispatch) {
      try {
        const json = await axios({
          ...
          url: "https://eventy-back.herokuapp.com/register",
        });
  ...
  return async function (dispatch) {
    try {
      const json = await axios({
        ...
        withCredentials: true,
        url: "https://eventy-back.herokuapp.com/login",
      });
  ...
  return async function (dispatch) {
    try {
      const json = await axios({
        method: "GET",
        withCredentials: true,
        url: "https://eventy-back.herokuapp.com/logout",
      });
  ...
  return async function (dispatch) {
    try {
      const json = await axios({
        method: "GET",
        withCredentials: true,
        url: "https://eventy-back.herokuapp.com/user",
      });
...
export function getEvent(name) {
  return function (dispatch){
    ...
    method: "GET",
    withCredentials: true,
    url: "https://eventy-back.herokuapp.com/event/" + name,
  })
  ...
  return async function (dispatch) {
    try {
      const json = await axios({
        ...
        withCredentials: true,
        url: "https://eventy-back.herokuapp.com/event",
      });
...
export function getAllEvents(){
  return function (dispatch){
      ...
      method: "GET",
      withCredentials: true,
      url: "https://eventy-back.herokuapp.com/allEvents",
    })
...
export function findEvent (parametro){
  return function (dispatch){
      ...
      method: "GET",
      withCredentials: true,
      url: "https://eventy-back.herokuapp.com/eventsAll/" + parametro,
    })
...
export function putUser(user){
  return function(dispatch){
    axios({
      method: "PUT",
      withCredentials: true,
      url: "https://eventy-back.herokuapp.com/user_update",
      data: {
  ...
  if(category === 'social'){
    return function (dispatch){
      axios({
        method: "GET",
        withCredentials: true,
        url: "https://eventy-back.herokuapp.com/socialEvents",
      })
    ...
    return function (dispatch){
      axios({
        method: "GET",
        withCredentials: true,
        url: "https://eventy-back.herokuapp.com/sportEvents",
      })
      .then(resultado => dispatch({type: FIND_EVENT_CATEGORY, payload: resultado.data}))
      .catch(err => alert(err))
    }
