    ...
    return(
        <div className = {styles.contenedor} key = {name}>
            ...
            <div className={styles.cont_info}>
                ...
                <div>
                    <FontAwesomeIcon className={`${colorIcon}`}  icon={faCalendarAlt} /> <span className = {styles.dateCard}>{date /*no cambiar esto -  se hizo el cambio de formato en la base de datos*/}</span>
                </div>
            </div>
